import os
rflist=os.listdir("C:/Users/김다빈/Desktop/데이터크롤링/프로젝트/crime1_original")
print(rflist)
print(rflist[0])
for i in rflist:
    s=''
    data=[]
    rfstr = "C:/Users/김다빈/Desktop/데이터크롤링/프로젝트/crime1_original/" + i
    rf = open(rfstr,"r")
    wf = open("C:/Users/김다빈/Desktop/데이터크롤링/프로젝트/crime1/"+str(i),"w+")
    wf.write("관서,발생건수\n")
    rf.readline()
    rf.readline()
...
for i in rflist:
    ...
    data=[]
    cnt=0
    rfstr = "C:/Users/김다빈/Desktop/데이터크롤링/프로젝트/crime1/" + i
    rf = open(rfstr,"r")
    wf = open("C:/Users/김다빈/Desktop/데이터크롤링/프로젝트/crime1/final/"+str(i),"w+")
    wf.write("관서,발생건수\n")
    rf.readline()
    lines = rf.readlines()
    lines.sort()
